export const gameDataStorage = [
    {
        ...
        link: "",
        description: "A latin american dice game involving 2-6 players. The page will allow the user to select the number of opponents (from 2-6) that they wish to play against. Then the game will proceed until the user has won, or has been eliminated from the game. They will then have the option to start a new game.",
    },
    {
        id: 2,
